...
//The code for MenuReviewItems in entity is donw below.
...
//Like UCSBDates, this is a test file that tests the MenuItemReviewsController class. Now do that for MenuItemReviewsControllerTests.java.
